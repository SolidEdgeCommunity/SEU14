...
skip:
    ...
    Public Function oGetSEFileCustomProperty(oFilename As String, oProperty As String) As String
        ...
        strFileName = oFilename
        Try
            propertySets = New SolidEdgeFileProperties.PropertySets
            propertySets.Open(strFileName, True)   '  open property stream READ ONLY

            pulledstring = propertySets.Item("Custom").Item(oProperty).Value
            propertySets.Close()
            oReleaseObject(propertySets)
            Return pulledstring
