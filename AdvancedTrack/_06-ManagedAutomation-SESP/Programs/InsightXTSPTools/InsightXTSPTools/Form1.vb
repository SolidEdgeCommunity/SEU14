...
Public Class Form1
    ...
    Public StrConfigureIXTServerInfoName As String = "ConfigureIXTServerInfo.xml"
    'Public strSESPServerDataPath As String = "C:\InsightXTData\"
    Public strSESPServerDataPath As String = "F:\InsightXTData\"
    Public strPulledSiteCollection As String = String.Empty
    Public strPulledServerName As String = String.Empty
    Public strPulledContentDBName As String = String.Empty
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.Text = "Solid Edge SP Tools  Version:" + Application.ProductVersion
        OleMessageFilter.Register()
        Dim strURL As String = String.Empty


        StrConfigureIXTServerInfoName = strSESPServerDataPath + StrConfigureIXTServerInfoName

        'read the xml file provided above to parse out the value of "LastConfiguredSiteCol"
        strPulledSiteCollection = readNodeFromXML(StrConfigureIXTServerInfoName, "LastConfiguredSiteCol")
        strPulledServerName = readContentDBFromXML(strSESPServerDataPath + "InsightXTInfo.xml", "Server")
        strPulledContentDBName = readContentDBFromXML(strSESPServerDataPath + "InsightXTInfo.xml", "Name")



        Me.TextBoxChekinURL.Text = strPulledSiteCollection
        Me.TextBoxURL.Text = strPulledSiteCollection
        Me.TextBoxNameOfServer.Text = strPulledServerName
        Me.TextBoxDBName.Text = strPulledContentDBName
        Me.TextBoxNameOfServer.Text = strPulledServerName
        Me.TextBoxSQLServer.Text = strPulledServerName
        Me.TextBoxSQLserverGUID.Text = strPulledServerName
        Me.TextBoxDBNameGUID.Text = strPulledContentDBName
        Me.TextBoxEmptyPartRevisions.Text = strPulledSiteCollection
        Me.TextBoxInvalidLastRevision.Text = strPulledSiteCollection
        Me.TextBoxUrlEditSPProperties.Text = strPulledSiteCollection
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        If IsValidSiteCollectionUrl(strSiteCollectionUrl) = True Then
            ...
            If arrayUrlOfFilesToCheckIn.Count > 0 Then
                'MessageBox.Show(arrayUrlOfFilesToCheckIn.Count.ToString)

                Dim oSiteCollection As New SPSite(strSiteCollectionUrl)

                'oSiteCollection.UserToken = _tUserToken
                'Dim strjunk As String = oSiteCollection.UserToken.ToString

                ' MessageBox.Show(strjunk)
                ...
                For iCounter = 0 To arrayUrlOfFilesToCheckIn.Count - 1
                    ...
                    For ii = 1 To oWebs.Count - 1
                        ...
                        Try
                            ...
                            If Not srcFile Is Nothing Then
                                srcFile.CheckIn("Checked in via utility", SPCheckinType.MajorCheckIn)
                                GoTo skip
                            End If

                        Catch ex As Exception
                            ' MessageBox.Show("Error checking in document " + arrayUrlOfFilesToCheckIn(iCounter).ToString + " ->" + ex.Message)
                        End Try
...
skip:
    ...
    Private Sub Button14_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button14.Click
        ...
        If IsValidSiteCollectionUrl(strSiteCollectionUrl) = True Then
            ...
            For ii = 1 To oWebs.Count - 1
                ...
                If Me.RadioButtonVerboseGUIDs.Checked = True Then
                ...
                Try
                    ...
                    For jj = 0 To spListCollection.Count - 1
                        ...
                        Dim deleteItems As List(Of SPListItem) = New List(Of SPListItem)
                        Dim oItemCollection As SPListItemCollection = oList.Items
                        Dim itemCount As Integer = oItemCollection.Count
                        For kk = 0 To itemCount - 1
                            Dim oItem As SPListItem = oItemCollection.Item(kk)
                            Dim strName1 As String
                            If oItem IsNot Nothing And oItem.File IsNot Nothing Then
                                strName1 = oItem.Name
                                If Me.RadioButtonVerboseGUIDs.Checked = True Then
                                    Me.ListBox2.Items.Add("Processing file " + oItem.Url)
                                    Me.ListBox2.Refresh()
                                End If

                                Dim bFileWithBadGuid As Boolean = False
                                blnSEFileFound = True
                                Dim strExt As String = strName1.Split(".").Last.ToLower
                                ...
                                If blnSEFileFound = True Then
                                    Try
                                        If oItem.Fields.ContainsField("PDM-GUID") Then
                                            Dim strJunk As String = oItem("PDM-GUID").ToString
                                            If strJunk.StartsWith("000000") Then
                                                bFileWithBadGuid = True
                                            End If
                                        End If
                                        If oItem.Fields.ContainsField("Rev-PDM-GUID") Then
                                            Dim strJunk1 As String = oItem("Rev-PDM-GUID").ToString
                                            If strJunk1.StartsWith("000000") Then
                                                bFileWithBadGuid = True
                                            End If
                                        End If

                                        If oItem.Fields.ContainsField("Item-PDM-GUID") Then
                                            Dim strJunk2 As String = oItem("Item-PDM-GUID").ToString
                                    ...
                                    If bFileWithBadGuid = True Then
                                        Dim strCtType As String = ""
                                        If oItem.File.ParentFolder IsNot Nothing And oItem.File.ParentFolder.Item IsNot Nothing Then
                                            Dim spParent As SPListItem = oItem.File.ParentFolder.Item
                                            strCtType = spParent.ContentType.Name
                                            If strCtType = "Folder" Then
                                                If spParent.Folder IsNot Nothing And spParent.Folder.ParentFolder IsNot Nothing Then
                                                    Dim spParentParent As SPListItem = spParent.Folder.ParentFolder.Item
                                                    strCtType = spParentParent.ContentType.Name
                                                End If
                                            End If
                                        End If
                                        If strCtType = "Part-Revision" Then
                                            Me.ListBox2.Items.Add("BAD GUID " + oItem.Url)
                                            Me.ListBox2.Refresh()
                                            intCTR = intCTR + 1
                        ...
                        Next kk
                        ''For Delete
                        'Dim dCount As Integer = deleteItems.Count
                        'If dCount > 0 Then
                        '    For dIndex = 0 To dCount - 1
                        '        deleteItems(dIndex).Delete()
                        '    Next
                        '    oList.Update()
                        'End If
                    Next jj
    ...
    Private Sub Button17_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button17.Click
        Dim strSiteCollectionUrl As String = TextBoxInvalidLastRevision.Text
        Dim ii As Integer
        Dim jj As Integer
        Dim kk As Integer
        Dim pp As Integer
        ...
        If IsValidSiteCollectionUrl(strSiteCollectionUrl) = True Then
            ...
            Me.ListBox3.Items.Add("Parts with invalid Last Revision SharePoint property")
            ...
            Label23.Text = "Processing ....  Please wait."
            Label23.Refresh()
            For ii = 1 To oWebs.Count - 1
                Dim srcSite As SPWeb = oWebs.Item(ii)
                Dim strName As String = srcSite.Name

                If Me.RadioButtonVerboseInvalidLastrevisionProperty.Checked = True Then
                    Me.ListBox3.Items.Add("checking ->" + strName)
                    Me.ListBox3.Refresh()
                End If
                    ...
                    For jj = 0 To spListCollection.Count - 1
                        ...
                        For kk = 0 To itemCount - 1
                            ...
                            If oItem IsNot Nothing Then
                                ...
                                'Me.ListBox2.Items.Add("Processing file " + oItem.Url)
                                'Me.ListBox2.Refresh()
                                Dim bFileWithBadLastRevision As Boolean = False
                                blnSEFileFound = True
                                Dim strExt As String = strName1.Split(".").Last.ToLower
                                'If strExt = "asm" Or strExt = "par" Or strExt = "psm" Or strExt = "dft" Or strExt = "pwd" Then
                                'blnSEFileFound = True
                                'End If
                                If Me.RadioButtonVerboseInvalidLastrevisionProperty.Checked = True Then
                                    Me.ListBox3.Items.Add("Processing folder " + oItem.DisplayName)
                                    Me.ListBox3.Refresh()
                                End If

                                If strPulledContentType = "part" Then  ' the Last Revision Property is on the Part Folder.
                                    'this gets the "part" folder
                                    'can get the folder properties from here!


                                    If oItem.Fields.ContainsField("Latest_x0020_Revision") Then
                                        Dim strJunk1 As String = oItem("Latest_x0020_Revision").ToString
                                        If strJunk1 = String.Empty Then
                                            Me.ListBox3.Items.Add("Invalid Last Revision property found in SharePoint-> " + oItem.DisplayName)
                                            Me.ListBox3.Refresh()
                                            intCTR = intCTR + 1
                                        End If
                                    End If
            ...
            Dim cnt As Integer = Me.ListBox2.Items.Count - 1
            Me.Label23.Text = "Found " + intCTR.ToString
            Me.Label23.Refresh()
            Me.Cursor = System.Windows.Forms.Cursors.Default
    ...
    Private Sub Button19_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button19.Click
        CopyListBoxToClipboard(Me.ListBox3)
    End Sub

    Private Sub Button22_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button22.Click
        Dim strSiteCollectionUrl As String = TextBoxUrlEditSPProperties.Text
        Dim ii As Integer
        Dim jj As Integer
        Dim kk As Integer
        Dim pp As Integer
        ...
        Dim oSPPartFolder As SPFolder = Nothing
        Dim oSPPartRevisionFolder As SPFolder = Nothing
        Dim oSPfile As SPFile = Nothing
        ...
        Dim ArrayOfFiles As ArrayList = Nothing
        ...
        If IsValidSiteCollectionUrl(strSiteCollectionUrl) = True Then
            ...
            Label25.Text = "Searching for specified part number in SharePoint ....  Please wait."
            Label25.Refresh()
            For ii = 1 To oWebs.Count - 1
                Dim srcSite As SPWeb = oWebs.Item(ii)
                Dim strName As String = srcSite.Name
                    ...
                    For jj = 0 To spListCollection.Count - 1
                        ...
                        For kk = 0 To itemCount - 1
                            ...
                            If oItem IsNot Nothing And oItem.File IsNot Nothing Then
                                ...
                                If Me.RadioButtonSearchBasedOnFileName.Checked = True Then
                                    If strName1.ToLower = Me.TextBox1.Text.ToLower Then
                                        'found the filename we are looking for

                                        If oItem.File IsNot Nothing Then
                                            oSPfile = oItem.File
                                            ArrayOfFiles.Add(oSPfile)
                                        End If

                                        If oItem.File.ParentFolder IsNot Nothing Then
                                            oSPPartRevisionFolder = oItem.File.ParentFolder.Item.Folder
                                        End If

                                        If oItem.File.ParentFolder.ParentFolder IsNot Nothing Then
                                            oSPPartFolder = oItem.File.ParentFolder.ParentFolder.Item.Folder
                                        End If
                                ...
                                If Me.RadioButtonSerchBasedOnPartNumber.Checked = True Then
                                    Dim strCtType As String = ""
                                    If oItem.File.ParentFolder IsNot Nothing And oItem.File.ParentFolder.Item IsNot Nothing Then
                                        Dim spParent As SPListItem = oItem.File.ParentFolder.Item
                                        strCtType = spParent.ContentType.Name
                                        If strCtType = "Part-Revision" Then
                                            If spParent.Folder IsNot Nothing Then



                                                If Me.TextBox1.Text.ToLower = spParent.DisplayName.ToLower Then
                                                    'found the part revision folder we are looking for we are looking for...  now need to loop through each file
                                                    If spParent.Folder IsNot Nothing Then
                                                        oSPPartRevisionFolder = spParent.Folder
                                                    End If
                                                    ...
                                                    If spParent.Folder.Files.Count > 0 Then  'make sure the part revision folder fold actually has files in it.
                                                        For Each SPFile In spParent.Folder.Files
                                                            oSPfile = Nothing
                                                            oSPfile = SPFile
                                                            ArrayOfFiles.Add(oSPfile)
                                                        Next
...
SPObjectFound:
            ...
            If ArrayOfFiles.Count = 0 Then
                MessageBox.Show("could not find the specified partnumber/file in SharePoint!")
                Exit Sub
            End If
