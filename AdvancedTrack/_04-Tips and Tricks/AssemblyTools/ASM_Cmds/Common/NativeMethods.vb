...
Namespace SolidEdge.CommonUI
	...
	Friend Enum ShowWindowCommands As Integer
		...
		''' is similar to <see ref="Win32.ShowWindowCommand.Normal"/>, except 
		...
		''' <see ref="Win32.ShowWindowCommand.ShowMinimized"/>, except the 
		''' window is not activated.
		''' </summary>
		ShowMinNoActive = 7
		''' <summary>
		''' Displays the window in its current size and position. This value is 
		''' similar to <see ref="Win32.ShowWindowCommand.Show"/>, except the 
		''' window is not activated.
		''' </summary>
		ShowNA = 8
		''' <summary>
