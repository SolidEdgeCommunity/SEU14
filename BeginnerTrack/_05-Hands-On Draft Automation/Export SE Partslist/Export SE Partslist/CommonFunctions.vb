...
Module CommonFunctions
    ...
    Public objExcel As Microsoft.Office.Interop.Excel.Application = Nothing





    'one example function to start/cnnect to Solid Edge that controlls app visibility, whether or not to display SE message dialogs that require user input, and
    'whether or not to stop Solid Edge and start another clean instance
    ...
    Public Function oConnectToExcel(ByVal blnAppVisibility As Boolean) As Boolean
        ...
        Try
            ...
            objExcel.Visible = blnAppVisibility
            blnExcelAlreadyRunning = True
            Return True

        Catch ex As System.Exception

            'Excel not running then start it
            Try
            ...
            Catch ex1 As Exception
                If objExcel Is Nothing Then
                    MessageBox.Show("Error starting the Excel Application. The error is " + ex1.Message, "Error starting Revision Manager", MessageBoxButtons.OK)
                End If
                Return False
        ...
        If objExcel Is Nothing Then
            MessageBox.Show("Could not start or connect to Excel", "Error starting or connecting to Excel", MessageBoxButtons.OK)
        End If
   ...
   ' Append a backslash (or any character) at the end of a path
    ...
    Public Function oGetPathOfFilename(ByVal oFileName As String) As String
        Try
            If oFileName.Contains("!") = True Then  'must be FOA
...
skip:
    ...
    Public Sub WriteToLogFile(oLogFileName As String, oStringToWrite As String)
