...
Namespace SolidEdge.ASM_Edgebar_Cmds
  ...
  ''' This class mananges all the edgebars for each ASM document.
  ''' Create one per active document and close the page when the document closes
  ''' Created from ASM_Edgebar_Cmds_Addin class     
	''' </summary>
